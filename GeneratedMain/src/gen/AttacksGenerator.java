...
public class AttacksGenerator extends Generator {
	...
	public void setup(ParseContext data){
		...
		directory = new File(Generators.general.getDirectory(),"entities/skills/attacks");
		directory.mkdirs();
	}
	public void generate(ParseContext data){
		ClassEntry idClass = (ClassEntry)new ClassEntry("entities.skills.attacks","Id",null,null,new ListEntry(),new ListEntry(),new ListEntry());
		idVariable = new VariableEntry("id",idClass);
		ClassEntry damageClass = (ClassEntry)Generators.general.init(new ClassEntry("entities.skills.attacks","Damage",null,null,new ListEntry(new VariableEntry("value","Float","0f"),new VariableEntry("modifier","Float","1f"),new VariableEntry("hit","Boolean","false")),new ListEntry(new MethodEntry("setValue","void",new ListEntry(new VariableEntry("newValue","Float")),new ListEntry(new ElementEntry(GeneralGenerator.semicolonedElement,new ListEntry(new StringEntry("value = newValue"))))),new MethodEntry("setModifier","void",new ListEntry(new VariableEntry("newModifier","Float")),new ListEntry(new ElementEntry(GeneralGenerator.semicolonedElement,new ListEntry(new StringEntry("modifier = newModifier"))))),new MethodEntry("setHit","void",new ListEntry(new VariableEntry("newHit","Boolean")),new ListEntry(new ElementEntry(GeneralGenerator.semicolonedElement,new ListEntry(new StringEntry("hit = newHit"))))),new MethodEntry("getTotal","Float",new ListEntry(),new ListEntry(new ElementEntry(GeneralGenerator.returnCallElement,new ListEntry(new StringEntry("value*modifier")))))),new ListEntry()));
		superAttacksClass = Generators.general.init(new ClassEntry("entities.skills.attacks","Attacks",null,null,new ListEntry(),new ListEntry(),new ListEntry(idClass)));
		superAttacksClass.addImport("misc","Range");
		superAttackClass = Generators.general.init(new ClassEntry("entities.skills.attacks","Attack",Generators.general.get("Skill"),new ListEntry(Generators.general.get("Source")),new ListEntry(),new ListEntry(new MethodEntry("attack","void",new ListEntry(new VariableEntry("attacker","Entity"),new VariableEntry("defender","Entity")),new ListEntry(new ElementEntry(AttacksGenerator.attackAttackBodyElement,new ListEntry()))),new MethodEntry("getDamage","Attack.Damage",new ListEntry(new VariableEntry("attacker","Entity"),new VariableEntry("defender","Entity")),new ListEntry(new ElementEntry(GeneralGenerator.returnCallElement,new ListEntry(new StringEntry("null"))))),new MethodEntry("getId","Attacks.Id",new ListEntry(),new ListEntry(new ElementEntry(GeneralGenerator.returnCallElement,new ListEntry(new StringEntry("null")))))),new ListEntry(damageClass)));
	...
	public Entry generateAttackDeclaration(IToken attackDeclaration){
		...
		ClassEntry attackClass = new ClassEntry("entities.skills.attacks",attackName,superAttackClass,null,new ListEntry(idVariable.get("PUBLIC").get("STATIC_FINAL")),new ListEntry(),new ListEntry());
