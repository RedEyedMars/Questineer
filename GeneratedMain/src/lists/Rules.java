...
public class Rules extends ParseList {
	...
	public static final IRule item_hit_element = ItemHitElement.parser;
	...
	public static final IRule stat_range = StatRange.parser;
	...
	public static final IRule tile_definition_element = TileDefinitionElement.parser;
	...
	public static final IRule activity_statement = ActivityStatement.parser;
	public static final IRule association_statement = AssociationStatement.parser;
	...
	public static final IRule isA_statement = IsAStatement.parser;
	...
	public static final IRule animation_variable_value_basic = AnimationVariableValueBasic.parser;
