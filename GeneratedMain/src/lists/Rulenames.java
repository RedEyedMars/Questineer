...
public class Rulenames extends ParseList {
	...
	public static final RegexParser area_declaration = new RegexParser("area_declaration","rulenames","area_declaration");
	public static final RegexParser area_element = new RegexParser("area_element","rulenames","area_element");
	public static final RegexParser patch_element = new RegexParser("patch_element","rulenames","patch_element");
	...
	public static final RegexParser direction_name = new RegexParser("direction_name","rulenames","direction_name");
	public static final RegexParser edge_definition = new RegexParser("edge_definition","rulenames","edge_definition");
	public static final RegexParser edge_if = new RegexParser("edge_if","rulenames","edge_if");
	public static final RegexParser edge_if_operator = new RegexParser("edge_if_operator","rulenames","edge_if_operator");
	public static final RegexParser tile_definition = new RegexParser("tile_definition","rulenames","tile_definition");
	public static final RegexParser tile_definition_element = new RegexParser("tile_definition_element","rulenames","tile_definition_element");
	public static final RegexParser tile_element = new RegexParser("tile_element","rulenames","tile_element");
	public static final RegexParser tile_rate = new RegexParser("tile_rate","rulenames","tile_rate");
	...
	public static final RegexParser animation_type_declaration = new RegexParser("animation_type_declaration","rulenames","animation_type_declaration");
	public static final RegexParser animation_type_element = new RegexParser("animation_type_element","rulenames","animation_type_element");
	public static final RegexParser animation_type_boolean = new RegexParser("animation_type_boolean","rulenames","animation_type_boolean");
	public static final RegexParser animation_type_variable_declaration = new RegexParser("animation_type_variable_declaration","rulenames","animation_type_variable_declaration");
	public static final RegexParser animation_variable_value = new RegexParser("animation_variable_value","rulenames","animation_variable_value");
	public static final RegexParser animation_variable_value_basic = new RegexParser("animation_variable_value_basic","rulenames","animation_variable_value_basic");
	public static final RegexParser anit_continuation_operator = new RegexParser("anit_continuation_operator","rulenames","anit_continuation_operator");
	public static final RegexParser anit_operator = new RegexParser("anit_operator","rulenames","anit_operator");
	public static final RegexParser anit_arithmetic_operator = new RegexParser("anit_arithmetic_operator","rulenames","anit_arithmetic_operator");
	public static final RegexParser anit_boolean_operator = new RegexParser("anit_boolean_operator","rulenames","anit_boolean_operator");
	public static final RegexParser image_type = new RegexParser("image_type","rulenames","image_type");
	public static final RegexParser image_declaration = new RegexParser("image_declaration","rulenames","image_declaration");
	public static final RegexParser animation_state = new RegexParser("animation_state","rulenames","animation_state");
	...
	public static final RegexParser multiple_drawable_declaration = new RegexParser("multiple_drawable_declaration","rulenames","multiple_drawable_declaration");
	public static final RegexParser drawable_declaration = new RegexParser("drawable_declaration","rulenames","drawable_declaration");
	public static final RegexParser drawable_grid_element = new RegexParser("drawable_grid_element","rulenames","drawable_grid_element");
	public static final RegexParser drawable_multiple_element = new RegexParser("drawable_multiple_element","rulenames","drawable_multiple_element");
	public static final RegexParser drawable_arthmetic_operator = new RegexParser("drawable_arthmetic_operator","rulenames","drawable_arthmetic_operator");
	public static final RegexParser drawable_multiple_value = new RegexParser("drawable_multiple_value","rulenames","drawable_multiple_value");
	public static final RegexParser colour_declaration = new RegexParser("colour_declaration","rulenames","colour_declaration");
